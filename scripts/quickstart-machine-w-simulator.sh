...
QUICKSTART_ARGS="-pxclimin 0.6.3 -ba -uaa -asset -eh -wd -nsts -mc $SCRIPT"
...
echo "We built and deployed the Machine Adapter bundle which generates sample data" >> "$SUMMARY_TEXTFILE"
echo "" >> "$SUMMARY_TEXTFILE"
